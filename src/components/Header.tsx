        ...
        <div className="flex flex-row justify-between py-4 px-10 bg-black h-[100px] items-center">
            ...
            {type === "home" ?
                <div className="flex flex-row sm:gap-7 md:gap-11 lg:gap-20">
                    ...
                    <div className="flex flex-col items-center gap-1 cursor-pointer" onClick={() => navigate('/curation')}>
                        <div className="bg-gray-600 w-10 h-10" />
                    ...
                    <div className="flex flex-col items-center gap-1 cursor-pointer" onClick={() => navigate("/channels/detail")}
                    >
                        <div className="bg-gray-600 w-10 h-10" />
                ...
                <div className="flex flex-row gap-5">
                    <img src={BackArrowIcon} className="cursor-pointer mr-6" onClick={() => navigate(-1)} />
                    <img src={PickleLogo} />
