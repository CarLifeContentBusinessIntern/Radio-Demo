...
function AppRoutes() {
  ...
  useEffect(() => {
    const highPriorityTimer = setTimeout(() => {
      ...
      const imageUrls = [
        './assets/ai_pick_banner_background.webp',
        './assets/ai_pick_banner_icon.webp',
        './assets/ai_pick_banner_background_after.webp',
        './assets/ai_pick_banner_dailymix_after.webp',
      ];
